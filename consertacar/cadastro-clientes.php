...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if ($control->inserir($_POST['nome'], $_POST['cpf'], $_POST['email'], $_POST['dataNascimento'], $_POST['telefone'])) {
                        ...
                        <div class="panel panel-default">
                            <form action="" method="POST" id="form"> 
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="campo_esquerda">
                                        <input type="email" class="form-control" value="<?php echo (isset($_POST['email']) ? $_POST['email'] : ""); ?>" name="email" id="email" placeholder="Informe o email" required="required" data-toggle="tooltip" title="Informe o email" data-placement="auto"/>
                                    </div>
                                    <div class="campo_direita">
                                        <input type="date" class="form-control" value="<?php echo (isset($_POST['dataNascimento']) ? $_POST['dataNascimento'] : ""); ?>" name="dataNascimento" id="dataNascimento" placeholder="Informe a data de nascimento" required="required" data-toggle="tooltip" title="Informe a data de nascimento" data-placement="auto" />
                                    </div>
                                    <div class="campo_esquerda">
