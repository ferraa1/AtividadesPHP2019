...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if ($control->inserir($_POST['placa'], $_POST['marca'], $_POST['modelo'], $_POST['ano'], $_POST['quilometragem'], $_POST['cliente'])) {
        $mensagem = "Automóvel inserido com sucesso";
        unset($_POST);
    } else {
        $erros = "";
                        ...
                        <div class="panel panel-default">
                            <form action="" method="POST" id="form"> 
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="campo_esquerda">
                                        <input type="number" class="form-control" value="<?php echo (isset($_POST['quilometragem']) ? $_POST['quilometragem'] : ""); ?>" name="quilometragem" id="quilometragem" placeholder="Informe a quilometragem" required="required" data-toggle="tooltip" title="Informe a quilometragem" data-placement="auto"/>
                                    </div>
                                    <div class="campo_direita">
                                        <select class="form-control" name="cliente">
                                            <option value="" placeholder="Informe o cliente" required="required" data-toggle="tooltip" title="Informe o cliente" data-placement="auto">Informe o cliente</option>
